...
- Nenhuma decisão técnica pode ser tratada como confirmada sem aprovação explícita do usuário.
- Nenhuma suposição pode ser registrada como fato, padrão, tecnologia, dependência, estrutura de diretórios, nome ou regra técnica.
